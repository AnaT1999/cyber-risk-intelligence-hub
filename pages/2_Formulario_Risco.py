...
st.set_page_config(page_title="Formulário de Risco", layout="wide", page_icon=":material/shield:")

apply_custom_theme()

render_hero_section(
    title="Avaliação Unificada de Risco",
    subtitle="Quantifique a postura de cibersegurança da sua organização. Este questionário cruza dados financeiros, organizacionais e de infraestrutura técnica (NIST & FAIR).",
    image_url=HERO_IMAGES["matrix"]
)
...
if submitted:
    ...
    reach_simulated = int(media_exposure * 10000)
    ...
    # CSS Específico para manter as cores dos botões de exportação (PDF = Vermelho, Excel = Verde, JSON = Laranja)
    st.markdown("""
    <style>
